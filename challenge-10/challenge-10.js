(function(){
    ...
    */
    const showErrorMessage = (operador) => `Operação ${operador} não permitida`;
    ...
    */
    let operadorInvalido = "#"
    var invalido = calculator(operadorInvalido);

    console.log(showOperationMessage(number1, "-", number2), subtraction(number1, number2));
    console.log(showOperationMessage(number1, "*", number2), multiplicacao(number1, number2));
    console.log(showOperationMessage(number1, "/", number2), divisao(number1, number2));
    console.log(showOperationMessage(number1, "%", number2), mod(number1, number2));
    if(invalido !== false){
        console.log(invalido(1,1))
    }else{
        console.log(showErrorMessage(operadorInvalido));
    }
